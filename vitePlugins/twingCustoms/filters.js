...
export default [
  ...
  createFilter(
    'without',
    async function (_executionContext, obj, key1, key2, key3, key4, key5) {
      if (!obj || typeof obj !== 'object') {
        return obj;
      }

      // Collect all non-undefined keys to remove
      const keysToRemove = [key1, key2, key3, key4, key5].filter(
        (key) => key !== undefined
      );
    ...
    [
      ...
      { name: 'key1', defaultValue: null },
      { name: 'key2', defaultValue: null },
      { name: 'key3', defaultValue: null },
      { name: 'key4', defaultValue: null },
      { name: 'key5', defaultValue: null },
    ]
  ),
];
